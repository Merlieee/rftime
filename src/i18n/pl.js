...
export default {
  ...
  editions: {
    e2026: {
      ...
      highlights: [
        ...
        { label: '5 transmisji live',      desc: 'Frankfurt, Lubeka, Barcelona i 2× Lublin — w czasie rzeczywistym' },
      ...
      committeeExtra: [
        { name: 'Michał Peller',  title: 'dr hab. n. med.', location: ['I Katedra i Klinika Kardiologii, Warszawski Uniwersytet Medyczny, Polska', 'Uniwersyteckie Centrum Kliniczne WUM (Centralny Szpital Kliniczny), Warszawa, Polska'] },
        { name: 'Marcin Szczasny', title: 'dr n. med.',     location: ['Wojewódzki Szpital Specjalistyczny w Lublinie (al. Kraśnicka), Polska'] },
      ],
      program: [
        {
          ...
          items: [
            ...
            { time: '10:30–12:45', title: 'Zabieg live: Ablacja poza PVI systemem Volt™ PFA II generacji — izolacja żyły głównej górnej (SVC)',            speaker: 'M. Wójcik, P. Błaszkiewicz' },
            ...
            { time: '14:30–15:15', title: 'Wykład: Clinical Anatomy for Electrophysiology — Session 2: How to ablate ventricular arrhythmias, from specimen to catheter', speaker: 'M. Didenko' },
            { time: '15:15–15:45', title: 'Przerwa kawowa',                                                                                                speaker: '' },
            { time: '15:45–16:00', title: 'Prezentacja ciekawych przypadków przez uczestników RFtime',                                                     speaker: 'Moderatorzy: TBC' },
            { time: '16:00–17:30', title: 'Wykład: TactiFlex™ Duo w trudnych celach ablacyjnych + case: Ablacja VT — protokół S3, cewnik dual-energy PFA/RF (łączenie na żywo z Barceloną)', speaker: 'I. Roca-Luque' },
            { time: '17:30–19:00', title: 'Zabieg live: Re-ablacja atypowego AFL cewnikiem TactiFlex™ Duo',                                                 speaker: 'R. Kiedrowicz, M. Wójcik, P. Błaszkiewicz' },
            { time: '19:00–20:00', title: 'Kącik Młodego Elektrofizjologa: Prezentacja przypadków młodych uczestników',                                     speaker: 'Moderatorzy: TBC' },
            {
              ...
              speaker: 'Miejsce podamy później',
        ...
        },
        {
          ...
          items: [
            { time: '8:00–9:30',   title: 'Zabieg live z Lubeki: Ablacja VT/PVC z użyciem PFA (TactiFlex™ Duo)',                                            speaker: 'R. Tilz' },
            { time: '9:30–10:00',  title: 'Wykład: Ablacja PFA dodatkowych pobudzeń komorowych',                                                            speaker: 'R. Tilz' },
            { time: '10:00–10:15', title: 'Przerwa kawowa',                                                                                                 speaker: '' },
            { time: '10:15–11:45', title: 'Zabieg live z Lublina (USK nr 4): Ablacja substratu AF cewnikiem Affera™',                                        speaker: 'A. Hoffmann, A. Głowniak' },
            { time: '11:45–13:15', title: 'Zabieg live z Lublina (WSzS, al. Kraśnicka): Ablacja AF/AT cewnikiem dual-energy PFA/RF',                         speaker: 'M. Peller, M. Szczasny' },
            { time: '13:15–14:30', title: 'Zabieg live z Lublina (USK nr 4): Ablacja AF — OPAL HDx™ Software 7.0 + FARAVIEW™',                               speaker: 'A. Głowniak' },
  ...
  edition: {
    ...
    tabSpeakers: 'Prelegenci & Operatorzy',
    tabProgram: 'Program',
