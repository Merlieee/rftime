...
export default {
  ...
  editions: {
    e2026: {
      ...
      highlights: [
        ...
        { label: '5 live transmissions',   desc: 'Frankfurt, Lübeck, Barcelona, and 2× Lublin — in real time' },
      ...
      program: [
        {
          ...
          items: [
            ...
            { time: '10:30–12:45', title: 'Live procedure: Beyond-PVI ablation with the 2nd-generation Volt™ PFA system — superior vena cava (SVC) isolation', speaker: 'M. Wójcik, P. Błaszkiewicz' },
            ...
            { time: '14:30–15:15', title: 'Lecture: Clinical Anatomy for Electrophysiology — Session 2: How to ablate ventricular arrhythmias, from specimen to catheter', speaker: 'M. Didenko' },
            { time: '15:15–15:45', title: 'Coffee break',                                                                        speaker: '' },
            { time: '15:45–16:00', title: 'Interesting case presentations by RFtime participants',                              speaker: 'Moderators: TBC' },
            { time: '16:00–17:30', title: 'Lecture: TactiFlex™ Duo in challenging ablation targets + case: VT ablation — S3 protocol, dual-energy PFA/RF catheter (live link to Barcelona)', speaker: 'I. Roca-Luque' },
            { time: '17:30–19:00', title: 'Live procedure: Re-ablation of atypical AFL with the TactiFlex™ Duo catheter',       speaker: 'R. Kiedrowicz, M. Wójcik, P. Błaszkiewicz' },
        ...
        },
        {
          ...
          items: [
            { time: '8:00–9:30',   title: 'Live procedure from Lübeck: VT/PVC ablation using PFA (TactiFlex™ Duo)',              speaker: 'R. Tilz' },
            ...
            { time: '10:15–11:45', title: 'Live procedure from Lublin (University Clinical Hospital No. 4): AF substrate ablation with the Affera™ catheter',  speaker: 'A. Hoffmann, A. Głowniak' },
            { time: '11:45–13:15', title: 'Live procedure from Lublin (Provincial Specialist Hospital, al. Kraśnicka): AF/AT ablation with a dual-energy PFA/RF catheter', speaker: 'M. Peller, M. Szczasny' },
            { time: '13:15–14:30', title: 'Live procedure from Lublin (University Clinical Hospital No. 4): AF ablation — OPAL HDx™ Software 7.0 + FARAVIEW™', speaker: 'A. Głowniak' },
  ...
  edition: {
    ...
    tabSpeakers: 'Speakers & Operators',
  ...
  committee: {
    ...
    organizing: [
      ...
      { name: 'Radosław Kiedrowicz',  title: 'Prof., MD, PhD' },
